...
For deep graphs, see Advanced Guides: /docs/advanced-guides/nested-relationships

## Key binding

For foreign-key binding, see Advanced Guides: /docs/advanced-guides/key-binding
