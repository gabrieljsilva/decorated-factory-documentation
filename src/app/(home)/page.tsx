					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-fd-background p-6 rounded-xl shadow-sm">
							...
							<p className="text-fd-muted-foreground">
								Use TypeScript decorators to define how to generate data for
								each field of a class, making your code clean and readable.
							</p>
						</div>
						...
						<div className="bg-fd-background p-6 rounded-xl shadow-sm">
							...
							<p className="text-fd-muted-foreground">
								Easily create complex data structures with support for entity
								relationships, arrays, and key bindings.
							</p>
						</div>
						...
						<div className="bg-fd-background p-6 rounded-xl shadow-sm">
							...
							<p className="text-fd-muted-foreground">
								Generate realistic test data with minimal effort, making your
								tests more robust and easier to maintain.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="flex flex-col md:flex-row gap-12 items-center">
					<div className="flex-1">
						...
						<p className="text-lg text-fd-muted-foreground mb-6">
							Decorated Factory makes it easy to generate test data with just a
							few lines of code. Define your models once, and create instances
							with realistic data whenever you need them.
						</p>
						<Link
			...
			<section className="w-full bg-gradient-to-r from-fd-primary/10 to-fd-primary/5 py-16">
				<div className="max-w-6xl mx-auto px-4 text-center">
					...
					<p className="text-lg text-fd-muted-foreground mb-8 max-w-2xl mx-auto">
						Explore the documentation to learn more about Decorated Factory and
						how it can help you generate test data for your projects.
					</p>
					<Link
						href="/docs"
